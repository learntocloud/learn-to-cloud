...
- [Dev Containers in VS Code](https://www.youtube.com/watch?v=b1RavPr_878) - Quick intro (5 min)
- [Dev Containers Documentation](https://code.visualstudio.com/docs/devcontainers/containers) - Official docs
...
1. Go to[starter repo](https://github.com/learntocloud/journal-starter)
2. Click the star to keep up to date with any changes
3. Click on the fork button to create your own copy of the repo
4. All the implementation instructions are in the README.md file
