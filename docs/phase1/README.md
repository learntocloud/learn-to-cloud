...
- Join the [Learn to Cloud Discussions](https://github.com/learntocloud/learn-to-cloud-app/discussions)
    - Here you can ask questions and connect with other learners.
...
|-----|-------|-------------|
| 1 | [Version Control](1-versioncontrol.md) | Git, GitHub, and managing your code |
| 2 | [Cloud CLI](2-cli.md) | Command line interfaces for cloud platforms |
...
[Continue to Phase 2: Programming & AI Integration →](../phase2/README.md)
